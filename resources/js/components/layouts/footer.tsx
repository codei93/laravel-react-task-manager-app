...
export default function Footer() {
    ...
    return (
        <footer className="h-12 border-t border-gray-200 bg-white px-4 md:px-8 flex items-center justify-between text-xs text-gray-400">
             <div className="truncate">© 2026 Task Manager v1.0</div>
             <div className="flex items-center gap-2 md:gap-4">
                 ...
                 {linkedin && (
                     <a href={linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-gray-800 truncate">
                         LinkedIn
                     </a>
                 )}
                 {github && (
                     <a href={github} target="_blank" rel="noopener noreferrer" className="hover:text-gray-800 truncate">
                         GitHub
                     </a>
                 )}
             </div>
