...
> **Note:** Alternatively, you can run `composer run dev` to start the backend, queue worker, logs, and Vite dev server simultaneously (this command uses `npm run dev` internally).
